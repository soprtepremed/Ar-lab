...
async function run() {
    try {
        ...
        console.log('\n📦 Creando perfil Glucosa Post-Prandial...');
        const perfilQuery = `
            INSERT INTO estudios_laboratorio (
                codigo, nombre, categoria, precio, es_perfil, tipo_muestra, 
                tubo_recipiente, area, activo
            )
            VALUES ('GPP-PERFIL', 'Glucosa Post-Prandial', $1, 100, true, $2, $3, $4, true)
        ...
        console.log(`   ✅ GPP-PERFIL creado (ID: ${perfilId})`);
        ...
        console.log('========================================');
        console.log('📦 Perfil: Glucosa Post-Prandial ($100)');
